...
A MoLeR checkpoint trained using the default hyperparameters is available [here](https://figshare.com/ndownloader/files/34642724). If you save it under `MODEL_DIR`, then you can sample 10 molecules by running
